...
export default function CarPanel() {
    ...
    */
    ...
    // const mockCarRepo = [{cid:"001", name:"Honda Civic", image:'/civic.jpg'},
    // {cid:"002", name:"Honda Accord", image:'/accord.jpg'},
    // {cid:"003", name:"Toyota Fortuner", image:'/fortuner.jpg'},
    // {cid:"004", name:"Tesla Model 3", image:'/tesla.jpg'}]
    ...
    return (
        <div>   
            ...
            <input type="text" placeholder="please fill" className="block 
            text-gray-900 text-sm rounded-lg p-2 m-2 bg-purple-50 
            ring-1 ring-inset ring-purple-400 focus:outline-none focus:bg-purple-200
            focus:ring-2"
            ref={inputRef}/>
            <button className="block rounded-md bg-sky-600 hover:bg-indigo-600
            px-3 py-2 text-white shadow-sm"
