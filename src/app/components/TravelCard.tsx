...
export function TravelCard () {
    ...
    return (
        <div className="w-[80%] shadow-lg mx-[10%] my-10
        p-2 rounded-lg bg-gray-200 flex flex-row">
            <VlogPlayer isPlaying={playing} vdoSrc="/ThailandNatural.mp4" ></VlogPlayer>
            <div className="m-5">
                ...
                <Rating className="w-fit h-[10%]" value={(rating==undefined)? 0:rating}
