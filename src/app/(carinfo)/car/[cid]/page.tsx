...
export default async function CarDetailPage({params}: {params: {cid: string}}){
    ...
    // mockCarRepo.set("001", {name:"Honda Civic", image:'/civic.jpg'})
    // mockCarRepo.set("002", {name:"Honda Accord", image:'/accord.jpg'})
    // mockCarRepo.set("003", {name:"Toyota Fortuner", image:'/fortuner.jpg'})
    // mockCarRepo.set("004", { name:"Tesla Model 3", image:'/tesla.jpg'})
